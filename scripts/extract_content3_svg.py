"""Extract content3 SVG from agent transcript JSONL."""
import json
import re
...
OUT = Path(__file__).resolve().parent.parent / "assets" / "content3-design.svg"


def main() -> None:
    with TRANSCRIPT.open(encoding="utf-8") as f:
        for line in f:
            if 'width=\\"848\\" height=\\"365\\"' not in line:
                continue
            if "content3" not in line.lower():
                continue
            rec = json.loads(line)
